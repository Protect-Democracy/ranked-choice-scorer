#### Protect Democracy Open Source Project Template Instructions
...
```
bash -c "$(curl -s https://raw.githubusercontent.com/Protect-Democracy/development/main/open-source-template.sh)"
```
